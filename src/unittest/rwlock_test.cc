...
void run_rwlock_test() {
    ...
    ASSERT_TRUE(a->rwlock_read_signal()->is_pulsed());

    b.init(new rwlock_acq_t(&lock, rwlock_access_t::read));

    ASSERT_TRUE(b->rwlock_read_signal()->is_pulsed());

    c.init(new rwlock_acq_t(&lock, rwlock_access_t::write));

    ASSERT_TRUE(c->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(c->rwlock_write_signal()->is_pulsed());
    ...
    ASSERT_TRUE(c->rwlock_write_signal()->is_pulsed());

    d.init(new rwlock_acq_t(&lock, rwlock_access_t::read));
    e.init(new rwlock_acq_t(&lock, rwlock_access_t::read));

    ASSERT_FALSE(d->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(e->rwlock_read_signal()->is_pulsed());

    c.reset();

    ASSERT_TRUE(d->rwlock_read_signal()->is_pulsed());
    ASSERT_TRUE(e->rwlock_read_signal()->is_pulsed());
    ...
    ASSERT_TRUE(f->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(f->rwlock_write_signal()->is_pulsed());
    ASSERT_FALSE(g->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(h->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(i->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(j->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(j->rwlock_write_signal()->is_pulsed());
    ...
    ASSERT_TRUE(g->rwlock_read_signal()->is_pulsed());
    ASSERT_TRUE(i->rwlock_read_signal()->is_pulsed());
    ASSERT_TRUE(j->rwlock_read_signal()->is_pulsed());
    ASSERT_FALSE(j->rwlock_write_signal()->is_pulsed());
